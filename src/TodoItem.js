    ...
    return (
        <div className="card todo-item-container">
            <div className="todo-item-container-left">  
              ...
              <input 
                className={moment().isAfter(this.state.date)? "overdue": "notdue"}
              ...
              <button onClick={() => this.props.deleteTodoItem(id)} class="ui extra icon button"><i aria-hidden="true" class="trash alternate outline icon"></i></button>
          </div> 
        </div>
    );
  }
